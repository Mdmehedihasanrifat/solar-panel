...
function drawCircles() {
  ...
  var mercuryEllipse = $(".mercury_circle").eq(0);

  // Calculate the position and size values
  var leftValue = width / 2 - Rmercury;
  var topValue = height / 2 - Rmercury * verticalKaificent;
  var widthValue = Rmercury * 2; // Width remains the same for a circle
  var heightValue = Rmercury * 2 * verticalKaificent; // Adjusted height for an ellipse

  // Set the CSS styles using jQuery
  mercuryEllipse.css({
    left: leftValue + "px",
    top: topValue + "px",
    width: widthValue + "px",
    height: heightValue + "px",
    "border-radius": "50%", // Set border-radius to make it an ellipse
  });
  ...
  var earthEllipse = $(".earth_circle").eq(0);

  // Calculate the position and size values
  var leftValue = width / 2 - Rearth;
  var topValue = height / 2 - Rearth * verticalKaificent;
  var widthValue = Rearth * 2; // Width remains the same for a circle
  var heightValue = Rearth * 2 * verticalKaificent; // Adjusted height for an ellipse
